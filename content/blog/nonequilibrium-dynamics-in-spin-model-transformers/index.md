...
Evaluating Eq. \eqref{eq:sigma_hk} at the mean-field level (see [Appendix B](#appendix-b-mean-field-delayed-correlations-and-housekeeping-entropy-production)), we arrive at the following mean-field proxy for the stationary housekeeping entropy production of the stochastic parent process,
